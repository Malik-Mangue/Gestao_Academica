                                        ...
                                        <form method="post" action="index.php">
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="nome-<?= $campo->getCodigo() ?>" name="nome" class="form-control" value="<?= htmlspecialchars($campo->getNome()) ?>" required>
                                                </div>
                                            </div>
            ...
            <form method="post" action="index.php">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" id="novo-nome-campo" name="nome" class="form-control" placeholder="Ex: Tecnologias de Informação e Comunicação" required>
                    </div>
                </div>
                <div class="modal-footer">
                    <a href="#" class="btn btn-secondary">Cancelar</a>
